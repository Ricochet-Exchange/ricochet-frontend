...
const Logo = () => (
	<svg width="86" height="40" viewBox="0 0 86 40" fill="none" xmlns="http://www.w3.org/2000/svg">
		<g clipPath="url(#clip0)">
			<path
				d="M61.7789 29.7715H58.0566V18.7942C58.0566 18.7942 61.7795 19.0278 61.7795 21.1471L61.7789 29.7715Z"
				fill="#EDF3FB"
			/>
			<path
				d="M58.2661 8.09521H67.3565C69.9377 8.09521 74.581 8.93826 74.581 14.839C74.581 20.8602 68.5574 21.1012 68.5574 21.1012L74.2479 29.7715H70.4861L65.5468 22.3053V18.7942C65.5468 18.7942 70.943 19.5357 70.943 14.7196C70.943 11.1041 67.1753 11.1041 67.1753 11.1041L60.1476 10.8637C60.1476 10.8637 58.2661 10.3833 58.2661 8.09521Z"
				fill="#EDF3FB"
			/>
			<path
				d="M65.168 0.0270996H24.3126L34.6727 7.6139L0 20.0173L34.9263 32.6618L24.4604 40.0001L65.168 40.0076C76.6734 40.0076 86 31.0549 86 20.0173C86 8.97976 76.6734 0.0270996 65.168 0.0270996ZM65.168 35.5508C56.2271 35.5519 48.9805 28.597 48.9805 20.0173C48.9805 11.4377 56.2271 4.48277 65.168 4.48277C74.1089 4.48277 81.3567 11.4377 81.3567 20.0173C81.3567 28.597 74.1089 35.5519 65.168 35.5519V35.5508Z"
...
const Bank = ({ style = {}, fill = 'white', width = '50px', className = '', viewBox = '0 0 50 50' }) => (
	<svg
		width={width}
		style={style}
		height={width}
...
const Vault = ({ style = {}, fill = 'white', width = '50px', className = '', viewBox = '0 0 50 50' }) => (
	<svg
		width={width}
		style={style}
		height={width}
	...
	>
		...
		/>
		<path fill={fill} d="M21.42,22a5,5,0,0,1,1.1-1.11l-4.31-4.31a.78.78,0,1,0-1.11,1.1Z" />
		<path
			fill={fill}
			d="M34.34,16.59a.8.8,0,0,0-1.11,0l-4.57,4.38a5.22,5.22,0,0,1,1.08,1.12l4.57-4.37A.79.79,0,0,0,34.34,16.59Z"
		/>
		<path fill={fill} d="M29.67,28a5,5,0,0,1-1.1,1.11l4.31,4.31a.82.82,0,0,0,.56.23A.78.78,0,0,0,34,32.34Z" />
		<path
			fill={fill}
		...
		<path fill={fill} d="M10.1,20.29a.63.63,0,0,1-.62-.63v-2.5a.63.63,0,0,1,1.25,0v2.5A.63.63,0,0,1,10.1,20.29Z" />
		<path fill={fill} d="M10.1,33.72a.63.63,0,0,1-.62-.63v-2.5a.63.63,0,0,1,1.25,0v2.5A.63.63,0,0,1,10.1,33.72Z" />
	</svg>
);
...
const Vmark = ({
	...
	>
		<g id="Group_159" transform="translate(-627.931 -568.38)">
			<path
				id="Path_101"
				d="M637.744,588.38l-9.448-10a1.338,1.338,0,0,1,1.945-1.837l7.627,8.075,17.1-15.878a1.338,1.338,0,1,1,1.82,1.961Z"
				fill={fill}
			/>
		</g>
	</svg>
...
const Xmark = ({
	...
	>
		<path
			id="Path_99"
			d="M570.593,575.977l13.419-13.418a1,1,0,1,0-1.414-1.415l-13.419,13.419-13.42-13.419a1,1,0,0,0-1.414,1.415l13.42,13.418L554.345,589.4a1,1,0,0,0,1.414,1.415l13.42-13.419L582.6,590.811a1,1,0,1,0,1.414-1.415Z"
			transform="translate(-554.052 -560.852)"
			fill={fill}
		/>
	</svg>
);
