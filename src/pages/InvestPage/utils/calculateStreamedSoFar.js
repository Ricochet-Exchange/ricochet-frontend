...
const calculateStreamedSoFar = (balance, balanceTimestamp, flowRate) => {
	...
	return flowRateBigNumber.isZero()
		? ethers.utils.formatEther(balanceBigNumber)
		: ethers.utils.formatEther(
				balanceBigNumber.add(
					currentTimestampBigNumber.sub(balanceTimestampBigNumber).mul(flowRateBigNumber).div(1000),
				),
		  );
};
