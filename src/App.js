      ...
      <div class="container">
        <br/>
          <div class="row">
            ...
            <div class= "col-6">
            <h5 id="data-loading" class="badge bg-primary"><a style={{textDecoration:"none", color:"white" }} href="./RicochetExchangeWhitepaper.pdf">Whitepaper</a></h5>&nbsp;
            <h5 id="data-loading" class="badge bg-primary"><a style={{textDecoration:"none", color:"white" }} href="https://docs.ricochet.exchange/">Docs</a></h5>&nbsp;
            <h5 id="data-loading" class="badge bg-primary"><a style={{textDecoration:"none", color:"white" }} href="https://discord.gg/mss4t2ED3y">Discord</a></h5>&nbsp;
