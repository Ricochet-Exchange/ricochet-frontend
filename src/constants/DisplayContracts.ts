export const DisplayContracts = [
    {
        main_header: 'Super Tokens',
        column1: 'Token',
        column2: 'Token Address',
        contracts: [
    ...
    {
        main_header: 'V2Rex Market',
        column1: 'Market',
        column2: 'Contract Address',
        contracts: [
            ['USDC<>ETH', '0xc90c8339089C3070f513b36435a28C7917c88ffC'],
        ]
    },

    {
        main_header: 'V1 Rex Market',
        column1: 'Market',
        column2: 'Contract',
        contracts: [
            ...
            ['USDC>>rexSLP (ETH-USDC)', '0xeb367F6a0DDd531666D778BC096d212a235a6f78'],
            ['USDC>>rexSLP(ETH-IDLE)', '0x0cb9cd99dbC614d9a0B31c9014185DfbBe392eb5'],
...

    {
        ...
        column2: 'Contract',
        contracts: [
            ['Bank Version', '0xe78dC447d404695541b540F2FbB7682fd24d778B'],
        ]
    },

    {
        main_header: 'Rex Referral',
        column1: 'Name',
        column2: 'Contract',
        contracts: [
            ['Referral (Beta)', '0xA0eC9E1542485700110688b3e6FbebBDf23cd901'],
        ]
    },

    {
        main_header: 'Rex DAO Address',
        column1: 'Item',
        column2: 'Contract',
        contracts: [
