...
export const indexIDA: IndexIDAType = [
	...
	{
		exchangeAddress: daiEthMarketAddress,
		input: DAIxAddress,
		output: WETHxAddress,
		subsidy: RICAddress,
		subsidyIndex: 1,
	...
	{
		exchangeAddress: daiMaticMarketAddress,
		input: DAIxAddress,
		output: MATICxAddress,
		subsidy: RICAddress,
		subsidyIndex: 1,
	...
	{
		exchangeAddress: daiWbtcMarketAddress,
		input: DAIxAddress,
		output: WBTCxAddress,
		subsidy: RICAddress,
		subsidyIndex: 1,
	...
	{
		exchangeAddress: ethDaiMarketAddress,
		input: WETHxAddress,
		output: DAIxAddress,
		subsidy: RICAddress,
		subsidyIndex: 1,
	...
	{
		exchangeAddress: wbtcDaiMarketAddress,
		input: WBTCxAddress,
		output: DAIxAddress,
		subsidy: RICAddress,
		subsidyIndex: 1,
	...
	{
		exchangeAddress: maticDaiMarketAddress,
		input: MATICxAddress,
		output: DAIxAddress,
		subsidy: RICAddress,
		subsidyIndex: 1,
...
const markets: InvestmentFlow[] = [
	...
	{
		superToken: daiEthMarketAddress,
		tokenA: DAIxAddress,
		tokenB: WETHxAddress,
		coinA: Coin.DAI,
		coinB: Coin.WETH,
	...
	{
		superToken: daiMaticMarketAddress,
		tokenA: DAIxAddress,
		tokenB: MATICxAddress,
		coinA: Coin.DAI,
		coinB: Coin.MATIC,
	...
	{
		superToken: daiWbtcMarketAddress,
		tokenA: DAIxAddress,
		tokenB: WBTCxAddress,
		coinA: Coin.DAI,
		coinB: Coin.WBTC,
	...
	{
		superToken: wbtcDaiMarketAddress,
		tokenA: WBTCxAddress,
		tokenB: DAIxAddress,
		coinA: Coin.WBTC,
		coinB: Coin.DAI,
	...
	{
		superToken: ethDaiMarketAddress,
		tokenA: WETHxAddress,
		tokenB: DAIxAddress,
		coinA: Coin.WETH,
		coinB: Coin.DAI,
	...
	{
		superToken: maticDaiMarketAddress,
		tokenA: MATICxAddress,
		tokenB: DAIxAddress,
		coinA: Coin.MATIC,
		coinB: Coin.DAI,
