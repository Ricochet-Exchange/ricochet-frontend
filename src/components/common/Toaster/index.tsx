...
toast.configure({
	...
	closeOnClick: true,
	toastClassName: (context) => classNames(styles.toast, !!context?.type && styles[context.type]),
	bodyClassName: styles.body,
	closeButton: <Close />,
	autoClose: 3000,
});

const showToast = (content: ToastContent, type: TypeOptions = 'info', options?: ToastOptions) =>
	toast(content, {
		type,
		...(options || {}),
	});

const showSuccessToast = (text: string, title?: string, options?: ToastOptions) =>
