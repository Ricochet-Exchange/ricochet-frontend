...
export const InvestNav = () => {
	...
	return (
		<div className={styles.nav_container}>
			...
			<NavLink className={styles.nav_link} activeClassName={styles.nav_link_active} to={Routes.Banks}>
				<FontIcon name={FontIconName.Bank} size={16} />
				<div className={styles.nav_text}>{t('Banks')}</div>
			</NavLink>

			<NavLink className={styles.nav_link} activeClassName={styles.nav_link_active} to={Routes.Vaults}>
