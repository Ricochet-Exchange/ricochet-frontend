...
export const ModalCreateVaultContainer: FC<Props> = ({ bank, onCloseModal, visibleModal }) => {
	...
	const handleApproveToken = useCallback(() => {
		dispatch(
			banksApproveToken(bank.collateralToken.address, bank.bankAddress, vaultData.depositAmount, callbackApprove),
		);
	}, [dispatch, bank, vaultData.depositAmount]);
