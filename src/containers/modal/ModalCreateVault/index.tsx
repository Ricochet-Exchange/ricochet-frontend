		...
		switch (step) {
			case 1: {
                ...
                ${bank.debtToken.symbol}`}
						...
						<Button label="start" className={styles.start_button} onClick={onStartClick} />
					</>
				);
			}
			case 2: {
			...
			case 3: {
				return (
					<>
						...
						<Link to="/vaults?new=true" className={styles.link}>
							<Button label="view vault" className={styles.view_button} onClick={onCloseModal}>
